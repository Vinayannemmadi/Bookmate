...
import { LikeButton,LikedContainer,LikedMainContainer,BooksContainer,
    ImagesContainer,StyledImage ,CostLikeContainer} from './styledTrending';
    ...
    return (
        <LikedMainContainer>
            ...
            <h1 style={{textAlign:'center',fontFamily:'monospace',textDecoration:"underline",
                marginBottom:20}}>Signin to see your Trending Books</h1>:
            <h1 style={{textAlign:'center',fontFamily:'monospace',textDecoration:"underline",
                marginBottom:20}}> Trending Books</h1>}
            {newbooks.length <1 && token &&
                <h3 style={{textAlign:'center',fontFamily:'monospace',
                    marginBottom:20,color:'red',marginTop:100}}>
                    Trending books not available!. 
                </h3>}
            <BooksContainer>
